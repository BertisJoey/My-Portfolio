export default function About() {
    return (
        <div>
            <h1>About Me</h1>
            <p>
                Hello, my name is Joey Wiesner. I am currently attending a Full-Stack Coding Bootcamp hosted by Michigan State University. I graduated college from MSU 5 years ago with a degree in History in December of 2017, and have worked as a social worker for the Department of Health and Human Services ever since April of 2018. My job has been fulfilling and has given me great experience, but it became clear to me in the past couple years that I do not see myself continuing a career as a social worker and that I am looking to branch out.
            </p>
            <p>
